...
class SurveyQuestionOptionController extends Controller
{
    ...
    /**
     * @OA\Get(
     *     path="/moontransparency/public/api/surveyquestionoption",
    ...
    public function store(StoreSurveyQuestionOptionRequest $request)
    {
        ...
        $createdOptions = $this->surveyQuestionoptionService->createSurveyQuestionOptions($payload);
        return SurveyQuestionOptionResource::collection($createdOptions);
    }
