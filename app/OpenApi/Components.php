 ...
 *     @OA\Property(property="survey_variant", type="string", nullable=true, enum={"MONITORING_COMBINED", "MONITORING_MOON_ONLY"}, description="Obligatorio al finalizar KPT monitoreo."),
 ...
 *     @OA\Property(property="genero", type="string", nullable=true),
 *     @OA\Property(property="household_code", type="string", nullable=true, maxLength=64, example="HOG-000123"),
 *     @OA\Property(property="survey_variant", type="string", nullable=true, enum={"MONITORING_COMBINED", "MONITORING_MOON_ONLY"}),
